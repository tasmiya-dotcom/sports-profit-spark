        ...
        <div>
          ...
          <ResponsiveContainer width="100%" height={180}>
            <PieChart>
              ...
              <Tooltip contentStyle={{ background: '#1e1e1e', border: '1px solid #00e554', borderRadius: 8, color: '#ffffff' }} labelStyle={{ color: '#ffffff' }} />
            </PieChart>
          </ResponsiveContainer>
        </div>
        <div>
          ...
          <ResponsiveContainer width="100%" height={180}>
            <PieChart>
              ...
              <Tooltip contentStyle={{ background: '#1e1e1e', border: '1px solid #00e554', borderRadius: 8, color: '#ffffff' }} labelStyle={{ color: '#ffffff' }} formatter={(v: number) => `€${v.toLocaleString()}`} />
            </PieChart>
          </ResponsiveContainer>
        </div>
      </div>
