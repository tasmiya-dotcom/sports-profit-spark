        ...
        <div>
          ...
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={data} layout="vertical" margin={{ left: 100 }}>
              ...
              <YAxis type="category" dataKey="market" tick={{ fill: 'hsl(215 12% 52%)', fontSize: 11 }} width={95} />
              <Tooltip contentStyle={{ background: '#1e1e1e', border: '1px solid #00e554', borderRadius: 8, color: '#ffffff' }} labelStyle={{ color: '#888888' }} formatter={(v: number) => `€${v.toLocaleString()}`} />
